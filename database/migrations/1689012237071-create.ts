...
export class Create1689012237071 implements MigrationInterface {
  name = 'Create1689012237071';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "pet" ADD CONSTRAINT "FK_19909cfcf8cc0fffb7b45d2aa8a" FOREIGN KEY ("human_id") REFERENCES "human"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
